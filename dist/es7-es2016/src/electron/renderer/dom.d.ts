...
import { IEventPayload_R2_EVENT_CLIPBOARD_COPY, IEventPayload_R2_EVENT_READIUMCSS, IEventPayload_R2_EVENT_WEBVIEW_KEYDOWN } from "../common/events";
...
export declare function setKeyDownEventHandler(func: (ev: IEventPayload_R2_EVENT_WEBVIEW_KEYDOWN, elementName: string, elementAttributes: {
    [name: string]: string;
}) => void): void;
export declare function setKeyUpEventHandler(func: (ev: IEventPayload_R2_EVENT_WEBVIEW_KEYDOWN, elementName: string, elementAttributes: {
    [name: string]: string;
}) => void): void;
