...
function readiumCssOnOff() {
    const readiumCssJsonMessage1 = __computeReadiumCssJsonMessage(_webview1.READIUM2_LINK);
    _webview1.send(events_1.R2_EVENT_READIUMCSS, readiumCssJsonMessage1);
    const readiumCssJsonMessage2 = __computeReadiumCssJsonMessage(_webview2.READIUM2_LINK);
