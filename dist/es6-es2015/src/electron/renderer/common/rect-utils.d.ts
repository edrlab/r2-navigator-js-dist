...
export declare function getClientRectsNoOverlap(range: Range): IRect[];
export declare function getClientRectsNoOverlap_(clientRects: ClientRectList | DOMRectList): IRect[];
...
export declare function mergeTouchingRects(rects: IRect[], tolerance: number): IRect[];
