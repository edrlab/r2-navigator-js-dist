...
export declare function getClientRectsNoOverlap(range: Range, doNotMergeAlignedRects: boolean, vertical: boolean, expand?: number): IRect[];
export declare function getClientRectsNoOverlap_(clientRects: DOMRectList, doNotMergeAlignedRects: boolean, vertical: boolean, expand?: number): IRect[];
export declare function getClientRectsNoOverlap__(originalRects: IRect[], doNotMergeAlignedRects: boolean, vertical: boolean, expand?: number): IRect[];
