...
:root[style] > body > #${exports.ID_HIGHLIGHTS_CONTAINER} > .${exports.CLASS_HIGHLIGHT_CONTAINER}:not(.${exports.CLASS_HIGHLIGHT_BEHIND}),
:root > body > #${exports.ID_HIGHLIGHTS_CONTAINER} > .${exports.CLASS_HIGHLIGHT_CONTAINER}:not(.${exports.CLASS_HIGHLIGHT_BEHIND})
{
    opacity: 0.8;
}
