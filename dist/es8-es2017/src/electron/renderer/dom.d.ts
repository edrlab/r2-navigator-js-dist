...
import { IEventPayload_R2_EVENT_CLIPBOARD_COPY, IEventPayload_R2_EVENT_READIUMCSS, IKeyboardEvent, IEventPayload_R2_EVENT_IMAGE_CLICK } from "../common/events";
...
export declare function setImageClickHandler(cb: (payload: IEventPayload_R2_EVENT_IMAGE_CLICK) => void): void;
